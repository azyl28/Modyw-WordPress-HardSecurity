...
function hardsecurity_enqueue_scripts() {
    wp_enqueue_style('hardsecurity-fonts', 'https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700&family=Space+Grotesk:wght@300;400;500;600;700&display=swap', array(), '1.0.0');
    wp_enqueue_style('hardsecurity-main', HARDSECURITY_THEME_URI . '/assets/css/main.css', array(), '1.0.0');
    wp_enqueue_style('hardsecurity-bootstrap', HARDSECURITY_THEME_URI . '/assets/css/bootstrap.min.css', array(), '5.3.0');
    wp_enqueue_style('hardsecurity-fontawesome', HARDSECURITY_THEME_URI . '/assets/css/fontawesome.min.css', array(), '6.4.0');
    
    wp_enqueue_script('hardsecurity-bootstrap', HARDSECURITY_THEME_URI . '/assets/js/bootstrap.bundle.min.js', array('jquery'), '5.3.0', true);
    wp_enqueue_script('hardsecurity-main', HARDSECURITY_THEME_URI . '/assets/js/main.js', array('jquery'), '1.0.0', true);
    wp_enqueue_script('hardsecurity-navigation', HARDSECURITY_THEME_URI . '/js/navigation.js', array('jquery'), '1.0.0', true);
}
